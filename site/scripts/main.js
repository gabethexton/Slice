...
function storySwitcher (event){
  if (event.target.id === 'end' || event.target.id === 'quit') {
    ...
    window.location.assign('/site/thankyou.html');
...
// make choice buttons remove current story element and add another
  // use blah.innerHTML = var?
  // use display: none?
  // use show hide jquery?
//
// make new choice buttons and new next button?

// figure out weather API
  // read through documentation
  // determine relevant key value pairs
  // grab and use it
// set a weather var related to saved user input
// insert weather var into placeholder text
